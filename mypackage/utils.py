...
def features_seismic():
    well_seismic = loader()
    near_01_composite = pd.DataFrame(np.mean((np.mean(well_seismic['well_01']['near'],axis=1)), axis=0), columns=['near_01_composite'])
    near_11_composite = pd.DataFrame(np.mean((np.mean(well_seismic['well_11']['near'],axis=1)), axis=0), columns=['near_11_composite'])
    near_21_composite = pd.DataFrame(np.mean((np.mean(well_seismic['well_21']['near'],axis=1)), axis=0), columns=['near_21_composite'])
    near_25_composite = pd.DataFrame(np.mean((np.mean(well_seismic['well_25']['near'],axis=1)), axis=0), columns=['near_25_composite'])
    near_27_composite = pd.DataFrame(np.mean((np.mean(well_seismic['well_27']['near'],axis=1)), axis=0), columns=['near_27_composite'])
    near_33_composite = pd.DataFrame(np.mean((np.mean(well_seismic['well_33']['near'],axis=1)), axis=0), columns=['near_33_composite']) 
